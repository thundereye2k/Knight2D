...
public class StringHelper
{
    ...
    public static bool IsPasswordLong(string str)
    {
        return str.Length >= 8;
    }

    public static bool IsPasswordMatch(string str1, string str2)
    {
        return str1 == str2;
    }

    public static bool IsUsernameLong(string str)
    {
        return str.Length >= 3 && str.Length <= 24;
    }

    public static bool IsProfanity(string str)
    {
        var input = FilterProfanity(str);
        return input != str;
    }
}