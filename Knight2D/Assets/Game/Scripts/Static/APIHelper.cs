...
public class APIHelper
{
    ...
    public static bool IsPasswordMatch(string password, string verify)
    {
        if (password == verify)
        {
            return true;
    ...
    public static bool IsUsernameLong(string username)
    {
    ...
    public static bool IsProfanity(string username)
    {
        var input = FilterProfanity(username);
        if (input == username)
        {
            return true;
        }
